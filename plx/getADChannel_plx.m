function [adfreq, n, ts, fn, ad] = getADChannel_plx(filename, ch)
% getADChannel_plx(filename, channel): Read a/d data from a .plx file
%
% [adfreq, n, ts, fn, ad] = getADChannel_plx(filename, ch)
%
% INPUT:
