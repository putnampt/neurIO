function [n, ts, sv] = getEventChannel_plx(filename, ch)
% getEventChannel_plx(filename, channel) Read event timestamps from a .plx file
%
% [n, ts, sv] = getEventChannel_plx(filename, channel)
%
% INPUT:
