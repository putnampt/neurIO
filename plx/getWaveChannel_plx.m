function [n, npw, ts, wave] = getWaveChannel_plx(filename, ch, u)
% getWaveChannel_plx(filename, channel, unit): Read waveform data from a .plx file
%
% [n, npw, ts, wave] = getWaveChannel_plx(filename, channel, unit)
%
% INPUT:
